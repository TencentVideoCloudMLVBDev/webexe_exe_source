...
extern "C" 
{
	...
	*/
	...
	typedef void *TIMUserHandle;

	typedef void (*CBUserOnSuccess) (TIMUserHandle* handle_array, int size, void* data);
	typedef void (*CBUserOnError) (int code, const char* desc, void* data);

	typedef struct _TIMUserCallBack_c
	{
		CBUserOnSuccess  OnSuccess;
		CBUserOnError	OnError;
		void*		data;
	}TIMUserCB;
