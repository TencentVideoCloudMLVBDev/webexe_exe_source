...
public:
    ...
    void createRoom(const LRAuthData& authData, const QString& serverDomain, const std::string& ip, unsigned short port, const QString& roomID, const QString& roomInfo, bool record, int picture_id);
    void enterRoom(const LRAuthData& authData, const QString& serverDomain, const std::string& ip, unsigned short port, const QString& roomID, const QString& roomInfo, bool record, int picture_id);
...
private:
    ...
    std::string m_roomID;
    int m_audienceListTimerID = -1;
    int m_linkmicTimerID = -1;
    LinkMicStatus m_linkmicStatus = LinkMicOff;
    bool m_bCreate;
    QString m_roomInfo;
    QString m_userTag;
